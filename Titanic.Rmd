...
```{r}
train.df <- read.csv("C:\\Users\\Nathan\\Documents\\Kaggle-Titanic-Machine-Learning\\train - train.csv")

test.df <- read.csv("C:\\Users\\Nathan\\Documents\\Kaggle-Titanic-Machine-Learning\\test - test.csv")
```
...
Ms.df <- female.df %>%
  filter(str_detect(femaleNames, "Ms.") == TRUE)
